...
module.exports = {
  ...
  aliases: ["git"],
  category: "search",
  usage: "rex github <Name>",
  // exmaple: "Github Emoji",///
  description: `Github User Account Information!`,
  run: async (client, message, args) => {
    try {
      if (!args[0]) return message.noMentionReply(`Please Give Me A Username!`);
      ...
      return message.noMentionReply(`Something Went Wrong Try Again Later!`);
    }
  },
};
