...
module.exports = {
  ...
  category: "info",
  usage: "rex weather <location>",
  run: (client, message, args) => {
    if (!args.length) {
      return message.noMentionReply("Please give the weather location");
    }
    ...
    weather.find(
      ...
      function (err, result) {
        try {
          ...
          return message.noMentionReply("Unable To Get the data of Given location");
        }
      }
    );
    //LETS CHECK OUT PKG
